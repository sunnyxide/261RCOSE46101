...
\author{
  Sunwoo Ju \\
  Data Science, College of Informatics \\
  Team 8 \\
  2023320312
  \And
  Joshua Kim \\
...
AWS g6.xlarge (NVIDIA L4, 24GB VRAM). 4-bit NF4 with double quantization. Training: 45--90 min per 3B adapter; cross-cultural eval: $\sim$9 min per cell. Multi-seed for Cultural-KR ($n=3$, seeds 42/123/7777), single-seed otherwise.
...
The cross-cultural transfer matrix (Table~\ref{tab:crosscultural}) directly addresses this: Cultural-KR's KS to JP/US/CN remains within 0.05 of Vanilla-3B's baseline performance, supporting the \emph{reweighting} rather than \emph{deletion} interpretation.
